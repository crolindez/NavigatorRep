...
public class InFragment extends Fragment
{
    ...
    {
    	return  inflater.inflate(R.layout.in_layout, container, false);    
    }
    ...
    public void showProgress(boolean progress)
	{
    	if (progressAllowed)
    	{
        	if (progress)    getActivity().findViewById(R.id.loadingPanel_inList).setVisibility(View.VISIBLE);
        	else getActivity().findViewById(R.id.loadingPanel_inList).setVisibility(View.GONE);
